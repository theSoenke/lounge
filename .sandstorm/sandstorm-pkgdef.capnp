...
const pkgdef :Spk.PackageDefinition = (
  ...
  id = "jx33purhzfqmy0adu7h02ducg5zgmdtdpt0usys5g2z1ycjhg590",
  ...
  manifest = (
    ...
    actions = [
      ...
      ( nounPhrase = (defaultText = "IRC client"),
        command = .myCommand
    ...
    metadata = (
      ...
      website = "https://thelounge.github.io",
      # This should be the app's main website url.

      codeUrl = "https://github.com/theSoenke/lounge",
      ...
      shortDescription = (defaultText = "IRC client"),
